...
contract AddressChecker {
    event AddressMatch(bytes32 indexed _addr);
    event MultipleAddresses(bytes32[] _addr);
    ...
    function validate(bytes32 querySchema, address[] calldata _addr, bytes calldata extraData) external {
